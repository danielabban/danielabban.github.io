...
The full speech can be found in the link below. I used an R program to scrape the speech from the web(myjoyonline.com) and wrote a function in R to create the word cloud. The full reproducible code can be found [here](https://github.com/danielabban/word-cloud)
```{r}
